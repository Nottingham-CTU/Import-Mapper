...
# Test name: t04 Import repeating into longitudinal project
import pytest
import time
import json
...
class Test_04_Import_repeating_into_longitudinal_project:
  ...
  def test_04_Import_repeating_into_longitudinal_project(self):
    ...
    self.driver.find_element(By.ID, "map-name").send_keys(Keys.LEFT, "Test4a")
    ...
    sub=Sub1();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_mappingselect() # Run fn mappingselect
    self.vars["field"] = "3"
    self.vars["value"] = "string1::enrollment_arm_1::first_name"
    sub=Sub1();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_mappingselect() # Run fn mappingselect
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(@class,'btn-success')][contains(.,'Save')]").click()
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(.,'New mapping')]").click()
    self.driver.find_element(By.ID, "map-name").send_keys(Keys.LEFT, "Test4b")
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(.,'Continue')]").click()
    self.driver.find_element(By.ID, "csv").send_keys("REPODIR/tests/testdata2.csv")
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, ".alert-success")))
    self.driver.execute_script("//SETDESC:Verify CSV fields.")
    ...
    sub=Sub1();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_mappingselect() # Run fn mappingselect
    self.vars["field"] = "2"
    self.vars["value"] = "visit_2_arm_1"
    sub=Sub1();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_mappingselect() # Run fn mappingselect
    self.vars["field"] = "3"
    self.vars["value"] = "visit_lab_data"
    sub=Sub1();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_mappingselect() # Run fn mappingselect
    self.vars["field"] = "4"
    self.vars["value"] = "vld1"
    sub=Sub1();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_mappingselect() # Run fn mappingselect
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(.,'Add field mapping')]").click()
    self.vars["row"] = "3"
    self.vars["field"] = "1"
    ...
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'modal')]//div[contains(.,'Apply regex trans')]//input[contains(@placeholder,'Pattern')]").send_keys(Keys.LEFT, "/^.*?0*([0-9]+)$/")
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'modal')]//div[contains(.,'Apply regex trans')]//input[contains(@placeholder,'Replacement')]").send_keys(Keys.LEFT, "$1")
    ...
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(@class,'btn-success')][contains(.,'Save')]").click()
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(.,'New mapping')]").click()
    self.driver.find_element(By.ID, "map-name").send_keys(Keys.LEFT, "Test4c")
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(.,'Continue')]").click()
    self.driver.find_element(By.ID, "csv").send_keys("REPODIR/tests/testdata2.csv")
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, ".alert-success")))
    self.driver.execute_script("//SETDESC:Verify CSV fields.")
    ...
    self.driver.find_element(By.XPATH, "(//*[@id='import-wrangler']//button[contains(.,'Add')])[3]").click()
    self.driver.find_element(By.ID, "fieldRegexEnabled").click()
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'modal')]//div[contains(.,'Apply regex trans')]//input[contains(@placeholder,'Pattern')]").send_keys(Keys.LEFT, "/^.*?0*([0-9]+)-[0-9]{2}$/")
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'modal')]//div[contains(.,'Apply regex trans')]//input[contains(@placeholder,'Replacement')]").send_keys(Keys.LEFT, "$1")
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'modal')]//div[contains(.,'Apply regex trans')]//button[contains(.,'Save')]").click()
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(.,'Continue')]").click()
    None if (element := self.driver.find_element(By.CSS_SELECTOR, "input[aria-label=\"Enable record matching\"]")).is_selected() else element.click()
    ...
    self.vars["row"] = "3"
    self.vars["field"] = "1"
    self.vars["value"] = "int1::visit_2_arm_1::vld1"
    sub=Sub1();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_mappingselect() # Run fn mappingselect
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//button[contains(@class,'btn-success')][contains(.,'Save')]").click()
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'card-header')][contains(.,'Test4a')]//button[contains(.,'Import')]").click()
    self.driver.find_element(By.ID, "csv").send_keys("REPODIR/tests/testdata2.csv")
    ...
    assert len(self.driver.find_elements(By.XPATH, "//*[@id='import-wrangler']//table[contains(.,'Mapping Name')]//tr[contains(.,'Test4a')][contains(.,'Completed')]")) > 0
    ...
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'card-header')][contains(.,'Test4b')]//button[contains(.,'Import')]").click()
    self.driver.find_element(By.ID, "csv").send_keys("REPODIR/tests/testdata2.csv")
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.XPATH, "//div[contains(@class,'mb-3')][contains(.,'Vendre')]")))
    self.driver.execute_script("//SETDESC:Verify CSV preview.")
    self.driver.find_element(By.CSS_SELECTOR, "div.mb-3").send_keys("SAVESCREENSHOT")
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.XPATH, "//*[@id='import-wrangler']//table[contains(.,'Mapping Name')]")))
    sub=Sub2();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_runcron() # Run fn runcron
    assert len(self.driver.find_elements(By.XPATH, "//*[@id='import-wrangler']//table[contains(.,'Mapping Name')]//tr[contains(.,'Test4b')][contains(.,'Completed')]")) > 0
    self.driver.execute_script("//SETDESC:Verify import completed.")
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//table[contains(.,'Mapping Name')]").send_keys("SAVESCREENSHOT")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"DataEntry/record_home.php\"][href*=\"id=15\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a[onclick*=\"showFormInstanceSelector\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a.rc-form-menu-link[href*=\"DataEntry/index.php\"][href*=\"id=15\"][href*=\"page=visit_lab_data\"][href*=\"instance=1\"]").click()
    self.driver.execute_script("//SETDESC:Assert value")
    self.driver.find_element(By.NAME, "vld2").send_keys("SAVESCREENSHOT")
    assert self.driver.find_element(By.NAME, "vld2").get_attribute("value") == "2"
    self.driver.find_element(By.CSS_SELECTOR, "a[onclick*=\"showFormInstanceSelector\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a.rc-form-menu-link[href*=\"DataEntry/index.php\"][href*=\"id=15\"][href*=\"page=visit_lab_data\"][href*=\"instance=2\"]").click()
    self.driver.execute_script("//SETDESC:Assert value")
    self.driver.find_element(By.NAME, "vld2").send_keys("SAVESCREENSHOT")
    assert self.driver.find_element(By.NAME, "vld2").get_attribute("value") == "6"
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"prefix=import_mapper\"][href*=\"page=pages%2Fdashboard\"]").click()
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//div[contains(@class,'card-header')][contains(.,'Test4c')]//button[contains(.,'Import')]").click()
    self.driver.find_element(By.ID, "csv").send_keys("REPODIR/tests/testdata2.csv")
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.XPATH, "//div[contains(@class,'mb-3')][contains(.,'Vendre')]")))
    self.driver.execute_script("//SETDESC:Verify CSV preview.")
    self.driver.find_element(By.CSS_SELECTOR, "div.mb-3").send_keys("SAVESCREENSHOT")
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.XPATH, "//*[@id='import-wrangler']//table[contains(.,'Mapping Name')]")))
    sub=Sub2();sub.driver=self.driver;sub.vars=self.vars;sub.test_fn_runcron() # Run fn runcron
    assert len(self.driver.find_elements(By.XPATH, "//*[@id='import-wrangler']//table[contains(.,'Mapping Name')]//tr[contains(.,'Test4c')][contains(.,'Completed')]")) > 0
    self.driver.execute_script("//SETDESC:Verify import completed.")
    self.driver.find_element(By.XPATH, "//*[@id='import-wrangler']//table[contains(.,'Mapping Name')]").send_keys("SAVESCREENSHOT")
    self.driver.find_element(By.CSS_SELECTOR, "a[href*=\"DataEntry/record_status_dashboard.php\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "#record_status_table a[href*=\"DataEntry/index.php\"][href*=\"id=15\"][href*=\"page=demographics\"]").click()
    ...
    self.driver.execute_script("//SETDESC:Assert value")
    self.driver.find_element(By.NAME, "vld2").send_keys("SAVESCREENSHOT")
    assert self.driver.find_element(By.NAME, "vld2").get_attribute("value") == "1"
    self.driver.find_element(By.CSS_SELECTOR, "a[onclick*=\"showFormInstanceSelector\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "a.rc-form-menu-link[href*=\"DataEntry/index.php\"][href*=\"id=15\"][href*=\"page=visit_lab_data\"][href*=\"instance=2\"]").click()
    self.driver.execute_script("//SETDESC:Assert value")
    self.driver.find_element(By.NAME, "vld2").send_keys("SAVESCREENSHOT")
    assert self.driver.find_element(By.NAME, "vld2").get_attribute("value") == "5"
